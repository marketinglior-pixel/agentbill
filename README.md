...
- **It never reads a provider invoice** and keeps no price table. There is no currency field anywhere in the API. The console can show units as dollars, and take a ceiling in dollars, only at a rate you type into it; that is your estimate at your rate, and your invoices may differ. The rate is not saved to your account or anywhere in the API: it rides in the console page's address, so your browser history keeps it.
